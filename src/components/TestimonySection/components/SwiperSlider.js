  ...
  <>
    ...
    >
      {testimonials.map(testimony => (
        <SwiperSlide key={testimony.id} className="flex flex-col md:flex-row items-center justify-center gap-10 max-w-lg min-h-[360px] md:max-w-2xl lg:max-w-3xl w-full mx-auto mt-20 pt-10 md:pt-20 pb-10 px-10 rounded-lg border dark:border-gray-800 shadow-xl dark:shadow-none drop-shadow-xl dark:bg-slate-900 relative">
          ...
          <div className="flex-1 flex flex-col-reverse gap-10">
            ...
            <p className="text-lg relative text-justify min-h-7xl">
