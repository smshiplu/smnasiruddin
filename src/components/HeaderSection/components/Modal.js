      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-gradient-to-br from-gray-900 to-slate-800 text-white p-4 md:p-6 mt-80 md:mt-0 rounded-lg w-full shadow-xl cursor-default relative overflow-hidden overflow-y-auto"
          >
            <motion.button
