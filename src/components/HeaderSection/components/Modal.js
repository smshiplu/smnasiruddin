    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="bg-slate-900/20 backdrop-blur p-4 sm:p-8 fixed inset-0 z-50 grid place-items-center h-full cursor-pointer pointer-events-auto"
        >
          <motion.div
            ...
            className="bg-gradient-to-br from-gray-900 to-slate-800 text-white rounded-lg w-full shadow-xl cursor-default relative overflow-hidden overflow-y-auto box-border h-dvh p-10"
          >
            <motion.button
